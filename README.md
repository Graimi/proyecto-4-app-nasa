...
<li> [] Una vez tengamos a buen recaudo nuestra API Key podremos navegar hasta la sección de APOD (Astronomic Picture of the Day), inspeccionando tanto para lo que sirve como los endpoints y las queries que nos permite realizar: 
